...
//import com.HLKPfinal.repository.TokenRepository;
import com.HLKPfinal.security.JwtProvider;
//import com.HLKPfinal.security.Token;
...
//    public SignResponse logout(SignRequest request) throws Exception {
//        Member member = memberRepository.findByEmail(request.getEmail()).orElseThrow(() ->
//                new BadCredentialsException("잘못된 계정정보입니다."));
//
//        if (!passwordEncoder.matches(request.getPassword(), member.getPassword())) {
...
//    }
    ...
    public boolean register(SignRequest request) throws Exception {
        try {
            ...
            member.setRoles(Collections.singletonList(Authority.builder().name("ROLE_BABYCARE").build()));
